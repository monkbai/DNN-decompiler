...
class EfficientNetLite(nn.Module):
    def __init__(self, widthi_multiplier, depth_multiplier, num_classes):
        ...
        set_biases(self.fc, '0066.params_0.json')
...
if __name__ == '__main__':
    input_cat = "/home/BTD-data/Glow-2020/efficientnet/cat.bin"
    new_cat = "/home/BTD-data/Glow-2020/efficientnet/cat_transpose.bin"
    if len(sys.argv) == 2:
