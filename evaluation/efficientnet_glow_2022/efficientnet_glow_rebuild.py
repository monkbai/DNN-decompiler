...
if __name__ == '__main__':
    input_cat = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/Glow-2022/efficientnet/cat.bin"
    new_cat = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/Glow-2022/efficientnet/cat_transpose.bin"
    if len(sys.argv) == 2:
