...
if __name__ == '__main__':
    utils.funcs_dir = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.7/mobilenetv2_tvm_O0/mobilenet_funcs/"
    prog_path = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.7/mobilenetv2_tvm_O0/mobilenetv2_7_tvm_O0_strip"
    ...
    label_file = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.7/mobilenetv2_tvm_O0/label.txt"
    ...
    for asm_file in asm_files:
        if 'labels' not in asm_file and asm_file.endswith('.txt'):
            ...
            if start_addr in utils.addr2label.keys():
                ...
                if 'clip' in func_type or 'bias_add' in func_type or 'add' in func_type or 'global_avg_pool2d' in func_type:
