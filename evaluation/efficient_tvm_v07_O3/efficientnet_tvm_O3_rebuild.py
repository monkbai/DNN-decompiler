...
if __name__ == '__main__':
    input_cat = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.7/efficientnet_tvm_O3/cat.bin"
    new_cat = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.7/efficientnet_tvm_O3/cat_transpose.bin"
    if len(sys.argv) == 2:
