...
class MyResNet(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        set_weights(net[-1], './0141.weights_0.json')
        ...
        set_weights(net[-1], './0147.weights_0.json')
        ...
        net.append(nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0147.weights_1.json')
        ...
        net.append(nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0147.weights_2.json')
        ...
        net.append(nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0147.weights_3.json')
        ...
        set_weights(net[-1], './0158.weights_0.json')
        ...
        set_weights(net[-1], './0164.weights_0.json')
        ...
        net.append(nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0170.weights_1.json')
        ...
        net.append(nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0170.weights_2.json')
        ...
        set_weights(net[-1], './0175.weights_0.json')
        ...
        set_weights(net[-1], './0180.weights_0.json')
        ...
        set_weights(net[-1], './0186.weights_0.json')
        ...
        net.append(nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0186.weights_1.json')
        ...
        net.append(nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0186.weights_2.json')
        ...
        set_weights(net[-1], './0191.weights_0.json')
        ...
        set_weights(net[-1], './0197.weights_0.json')
        ...
        net.append(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0153.weights_1.json')
        ...
        net.append(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1))
        set_weights(net[-1], './0153.weights_2.json')
        ...
        set_weights(net[-1], './0200.dense_weights_0.json')
...
if __name__ == "__main__":
    ...
    with open("/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.9.dev/resnet18_tvm_O0/cat.bin", 'br') as f:
        bin_data = f.read()
