...
class SE_VGG(nn.Module):
    def __init__(self, num_classes):
        ...
        set_weights(net[0], './0047.weights_0.json')
        set_biases(net[0], './0029.biases_0.json')
        ...
        set_biases(net[2], './0029.biases_1.json')
        ...
        set_weights(net[5], './0059.weights_0.json')
        set_biases(net[5], './0032.biases_0.json')
        net.append(nn.ReLU())  # 6
        net.append(nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1))  # 7
        set_weights(net[7], './0065.weights_0.json')
        set_biases(net[7], './0032.biases_1.json')
        ...
        set_weights(net[10], './0071.weights_0.json')
        set_biases(net[10], './0035.biases_0.json')
        net.append(nn.ReLU())  # 11
        net.append(nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, padding=1, stride=1))  # 12
        set_weights(net[12], './0077.weights_0.json')
        set_biases(net[12], './0035.biases_1.json')
        net.append(nn.ReLU())  # 13
        net.append(nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, padding=1, stride=1))  # 14
        set_weights(net[14], './0077.weights_1.json')
        set_biases(net[14], './0035.biases_2.json')
        ...
        set_weights(net[17], './0083.weights_0.json')
        set_biases(net[17], './0038.biases_0.json')
        net.append(nn.ReLU())  # 18
        net.append(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=1, stride=1))  # 19
        set_weights(net[19], './0089.weights_0.json')
        set_biases(net[19], './0038.biases_1.json')
        net.append(nn.ReLU())  # 20
        net.append(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=1, stride=1))  # 21
        set_weights(net[21], './0089.weights_1.json')
        set_biases(net[21], './0038.biases_2.json')
        ...
        set_weights(net[24], './0095.weights_0.json')
        set_biases(net[24], './0041.biases_0.json')
        net.append(nn.ReLU())  # 25
        net.append(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=1, stride=1))  # 26
        set_weights(net[26], './0095.weights_1.json')
        set_biases(net[26], './0041.biases_1.json')
        net.append(nn.ReLU())  # 27
        net.append(nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=1, stride=1))  # 28
        set_weights(net[28], './0095.weights_2.json')
        set_biases(net[28], './0041.biases_2.json')
        ...
        set_weights(classifier[-1], './0098.dense_weights_0.json')
...
if __name__ == "__main__":
    input_cat = "/export/d1/zliudc/DLE_Decompiler/TVM/rebuild_ida/TVM-v0.8/vgg16_tvm_O0/cat.bin"
    if len(sys.argv) == 2:
