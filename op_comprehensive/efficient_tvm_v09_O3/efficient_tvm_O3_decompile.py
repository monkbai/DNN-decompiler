...
if __name__ == '__main__':
    utils.funcs_dir = "/home/lifter/Documents/DL_compiler/BTD_DATA/TVM-v0.9.dev/efficientnet_tvm_v09_O3/efficientnet_funcs/"
    prog_path = "/home/lifter/Documents/DL_compiler/BTD_DATA/TVM-v0.9.dev/efficientnet_tvm_v09_O3/efficientnet_lite4_tvm_O3_strip"
    in_data = "/home/lifter/Documents/DL_compiler/BTD_DATA/TVM-v0.9.dev/efficientnet_tvm_v09_O3/cat.bin"
    log_path = "/home/lifter/Documents/DL_compiler/BTD_DATA/TVM-v0.9.dev/efficientnet_tvm_v09_O3/func_call.log"
    label_file = "/home/lifter/Documents/DL_compiler/BTD_DATA/TVM-v0.9.dev/efficientnet_tvm_v09_O3/ground_truth.txt"
    ...
    for asm_file in asm_files:
        if 'labels' not in asm_file and asm_file.endswith('.txt'):
            ...
            if start_addr in utils.addr2label.keys():
                ...
                if 'avg_pool2d' in func_type or 'bias_add' in func_type:
