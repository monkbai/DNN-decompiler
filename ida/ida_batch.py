...
project_dir = rootdir = r"C:\Users\44916\Desktop\TVM_binaries"
ida_exe = r"C:\WorkSpace\tools\ollydbg_IDAPRO\IDA_Pro_v7.0_Portable\ida64.exe"
ida_cmd = ida_exe + r' -A -S"C:\Users\44916\Desktop\TVM_binaries\ida_lst.py" {}'
    ...
    for root, dirs, files in os.walk(work_dir):
        for file in files:
            ...
            if not os.path.exists(lst_path):
                status, output = cmd(ida_cmd.format(file_path))
                print(output)
                # input('before copy')
