...
if __name__ == '__main__':
    utils.funcs_dir = "/home/lifter/Documents/DL_compiler/BTD_DATA/Glow-2020/shakespeare/shakespeare_funcs"
    prog_path = "/home/lifter/Documents/DL_compiler/BTD_DATA/Glow-2020/shakespeare/shakespeare.out"
    in_data = ""
    log_path = "/home/lifter/Documents/DL_compiler/BTD_DATA/Glow-2020/shakespeare/func_call.log"
    label_file = "/home/lifter/Documents/DL_compiler/BTD_DATA/Glow-2020/shakespeare/ground_truth.txt"
    ...
    se_engine.extern_functions = {'0x401040': 'expf'}
                    ...
                    if 'insert_tensor' in func_type:  # there are two type of insert_tensor
                        ...
                        if not ins_ten_fixed_flag:
                            ...
                            for node in topo_list:
                                if node[1] == asm_file:
                                    node[2] = func_type
                    elif 'batchedadd' not in func_type:
                        continue  # no other operators to be recovered
    ...
    utils.extract_params_general(prog_path, in_data, (100, 50), '0x401220',
                                 mem_dump_log_path, '0008.txt', '0x409080')
