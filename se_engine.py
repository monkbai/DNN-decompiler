...
def record_ext_funcs(func_asm_path: str):
    ''' this function can only be used for asm generated by RetDec 
        asm generated by IDA does not containts ext_addr
    '''
...
def lightweight_SymEx(func_asm_path: str, log_file: str, exp_log_path: str, max_inst_num=5000000):
    ...
    logger.info('Symbolic Execution - Consumed Time: {}'.format(duration))
