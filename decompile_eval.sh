...
python3 ./embedding_tvm_O0_decompile.py $DATA_DIR/embedding/embedding_tvm_O0_funcs $DATA_DIR/embedding/embedding_tvm_O0 $DATA_DIR/embedding/label_tvm_O0.txt
...
# python3 ./embedding_tvm_O3_decompile.py $DATA_DIR/embedding/embedding_tvm_O3_funcs $DATA_DIR/embedding/embedding_tvm_O3 $DATA_DIR/embedding/label_tvm_O3.txt
...
# echo " - Rebuilt model output:"
# cd $CUR_DIR/evaluation/fasttext_embedding_tvm_v07_O3/
# python3 ./embedding_tvm_O3_rebuild.py 2>&-
# echo " - DNN Executable output:"
